 <div class="sidebar-nav">
   <ul>
    ...
    <li><ul class="dashboard-menu nav nav-list collapse in">
			...
			<li><a href="<?php echo base_url();?>department/adddepartment.php"><span class="fa fa-caret-right"></span>Add Department</a></li>
			...
			<li><a href="<?php echo base_url();?>book/addbook.php"><span class="fa fa-caret-right"></span>Add Book</a></li>
            <li><a href="<?php echo base_url();?>book/booklist.php"><span class="fa fa-caret-right"></span>Book List</a></li>
			
			<li><a href="<?php echo base_url();?>manage/issuebook.php"><span class="fa fa-caret-right"></span>Issue Book</a></li>
            <li><a href="<?php echo base_url();?>manage/issuelist.php"><span class="fa fa-caret-right"></span>Edit List</a></li>			
